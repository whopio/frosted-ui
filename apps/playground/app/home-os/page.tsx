            ...
            <div className={styles.root}>
              <div
                style={{
                  ...
                  background:
                    'linear-gradient(150deg, transparent 60%, var(--gray-2) 100%)',
                }}
              >
                <header
                  style={{
                  ...
                  >
                    <div style={{ flexGrow: 1 }}>
                      ...
                      <Text as="p" style={{ marginBottom: 'var(--space-4)' }}>
                        Nice apartment with a very cozy living room, a large
                        terrace, an equipped kitchen, two bedrooms and a
                        bathroom. The house is very bright thanks to the large
                        windows. It is located in a quiet area where several
                        means of transport that connect it both to the center of
                        the city in 15/20min and to the airport of Milan in 15
                        min.
                      </Text>
...
const ItemisedRow: React.FC<{ label: string; amount: string }> = ({
  label,
  amount,
}) => {
  return (
...
const LabelValueCard: React.FC<{ label: string; value: string }> = ({
  label,
  value,
}) => {
  return (
