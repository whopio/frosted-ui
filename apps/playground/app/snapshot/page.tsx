          ...
          <div id="root">
            ...
            <div className={styles.root}>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <div
                  style={{
                    ...
                    backgroundImage:
                      'linear-gradient(135deg, var(--black-a11), transparent)',
                  }}
                >
                  <div style={{ maxWidth: '35%' }}>
                    ...
                    >
                      ...
                      Expedita sed, sit recusandae rem debitis maxime id cumque
                      commodi iste alias optio ad beatae veniam fugiat dolorem
                    ...
                    <SubmitPhotoDialog>
                      <Button size="3">Submit a photo</Button>
                    </SubmitPhotoDialog>
                  </div>
                </div>
              </div>
              <div className={`${styles.container} ${styles.grid}`}>
                {[
                  '1601815560619-c5aeb2cb9297',
                  '1683223336014-06e82d91c95e',
                ].map((id) => (
