  ...
  render: (args) => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)', maxWidth: 400 }}>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-2)' }}>
        ...
        <Text size="1" color="gray">
          When enabled, users can change the value using the mouse wheel while the input is focused. The input must be
          both <strong>focused</strong> and <strong>hovered</strong> for the wheel to work.
        </Text>
      </div>
      ...
      <div style={{ display: 'flex', gap: 'var(--space-3)' }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <Text size="1" color="gray">
            <em>Wheel changes value</em>
          </Text>
        </div>
      </div>

      <Text size="1" color="gray">
        <strong>Tip:</strong> Hold <Code size="1">Shift</Code> for large steps or <Code size="1">Alt/Option</Code> for
        small steps while scrolling.
      </Text>
    </div>
  ),
};
