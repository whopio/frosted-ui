...
export const dragonFireA = {
  dragonFireA1: '#ff400004',
  dragonFireA2: '#ff46000b',
  dragonFireA3: '#ff39001b',
  dragonFireA4: '#ff400034',
  dragonFireA5: '#ff3e0047',
  dragonFireA6: '#ff3b005c',
  dragonFireA7: '#ff320072',
  dragonFireA8: '#f12e0091',
  dragonFireA9: '#fa3500e9',
  dragonFireA10: '#ec3400',
  dragonFireA11: '#dd2400',
  dragonFireA12: '#4e0e00e7',
};

export const dragonFireP3 = {
  dragonFire1: 'color(display-p3 0.9978 0.9885 0.9856)',
  dragonFire2: 'color(display-p3 0.9992 0.9689 0.9596)',
  dragonFire3: 'color(display-p3 1 0.9209 0.8965)',
  dragonFire4: 'color(display-p3 1 0.8524 0.8)',
  dragonFire5: 'color(display-p3 1 0.7925 0.724)',
  dragonFire6: 'color(display-p3 0.9936 0.7338 0.6567)',
  dragonFire7: 'color(display-p3 0.9501 0.6574 0.572)',
  dragonFire8: 'color(display-p3 0.9107 0.5559 0.4555)',
  dragonFire9: 'color(display-p3 0.9049 0.3335 0.1831)',
  dragonFire10: 'color(display-p3 0.8535 0.2731 0.1143)',
  dragonFire11: 'color(display-p3 0.7978 0.2236 0.0507)',
  dragonFire12: 'color(display-p3 0.3453 0.1605 0.1105)',
};

export const dragonFireP3A = {
  dragonFireA1: 'color(display-p3 0.7569 0.2667 0.0235 / 0.016)',
  dragonFireA2: 'color(display-p3 0.9137 0.2902 0.0196 / 0.044)',
  dragonFireA3: 'color(display-p3 0.8471 0.2314 0.0039 / 0.102)',
  dragonFireA4: 'color(display-p3 0.8824 0.2471 0.0078 / 0.197)',
  dragonFireA5: 'color(display-p3 0.8863 0.2392 0.0039 / 0.267)',
  dragonFireA6: 'color(display-p3 0.8745 0.2314 0.0039 / 0.346)',
  dragonFireA7: 'color(display-p3 0.8824 0.1961 0.0039 / 0.428)',
  dragonFireA8: 'color(display-p3 0.8353 0.1882 0 / 0.546)',
  dragonFireA9: 'color(display-p3 0.8863 0.1843 0 / 0.816)',
  dragonFireA10: 'color(display-p3 0.8275 0.1608 0 / 0.863)',
...
export const lemonLimeA = {
  lemonLimeA1: '#80aa0006',
  lemonLimeA2: '#a5d20011',
  lemonLimeA3: '#beee003a',
  lemonLimeA4: '#b8e60059',
  lemonLimeA5: '#b1d80075',
  lemonLimeA6: '#9fc00084',
  lemonLimeA7: '#8ca80092',
  lemonLimeA8: '#879f00bd',
  lemonLimeA9: '#d7f100',
  lemonLimeA10: '#cbe400ef',
  lemonLimeA11: '#6f7d00',
  lemonLimeA12: '#212800e2',
};

export const lemonLimeP3 = {
  lemonLime1: 'color(display-p3 0.9897 0.9925 0.9788)',
  lemonLime2: 'color(display-p3 0.9782 0.9885 0.9371)',
  lemonLime3: 'color(display-p3 0.9489 0.9835 0.7941)',
  lemonLime4: 'color(display-p3 0.9146 0.9617 0.6859)',
  lemonLime5: 'color(display-p3 0.8728 0.9274 0.5873)',
  lemonLime6: 'color(display-p3 0.8164 0.8701 0.5296)',
  lemonLime7: 'color(display-p3 0.7518 0.8027 0.4756)',
  lemonLime8: 'color(display-p3 0.6642 0.7184 0.3325)',
  lemonLime9: 'color(display-p3 0.8632 0.9421 0.2941)',
  lemonLime10: 'color(display-p3 0.8258 0.9005 0.2994)',
  lemonLime11: 'color(display-p3 0.4463 0.4898 0.1262)',
  lemonLime12: 'color(display-p3 0.231 0.2493 0.1314)',
};

export const lemonLimeP3A = {
  lemonLimeA1: 'color(display-p3 0.5137 0.6745 0.0235 / 0.024)',
  lemonLimeA2: 'color(display-p3 0.6902 0.8157 0.0078 / 0.063)',
  lemonLimeA3: 'color(display-p3 0.7569 0.9255 0.0039 / 0.208)',
  lemonLimeA4: 'color(display-p3 0.7255 0.8784 0.0039 / 0.314)',
  lemonLimeA5: 'color(display-p3 0.6863 0.8196 0.0039 / 0.412)',
  lemonLimeA6: 'color(display-p3 0.6118 0.7176 0.0039 / 0.471)',
  lemonLimeA7: 'color(display-p3 0.5294 0.6196 0 / 0.526)',
  lemonLimeA8: 'color(display-p3 0.4941 0.5765 0 / 0.667)',
  lemonLimeA9: 'color(display-p3 0.8039 0.9137 0 / 0.695)',
  lemonLimeA10: 'color(display-p3 0.7569 0.8549 0 / 0.702)',
...
export const electricIndigo = {
  ...
  electricIndigo3: '#f0f0ff',
  electricIndigo4: '#e5e5ff',
  electricIndigo5: '#dadaff',
  electricIndigo6: '#cbcbff',
  electricIndigo7: '#b8b5ff',
  electricIndigo8: '#9e95ff',
  electricIndigo9: '#6318f8',
  electricIndigo10: '#5800e6',
  electricIndigo11: '#642ef1',
  electricIndigo12: '#2f1978',
};

export const electricIndigoA = {
  electricIndigoA1: '#0000ff02',
  electricIndigoA2: '#0020ff08',
  electricIndigoA3: '#0000ff0f',
  electricIndigoA4: '#0000ff1a',
  electricIndigoA5: '#0000ff25',
  electricIndigoA6: '#0000ff34',
  electricIndigoA7: '#0b01ff4a',
  electricIndigoA8: '#1601ff6a',
  electricIndigoA9: '#5300f7e7',
  electricIndigoA10: '#5800e6',
  electricIndigoA11: '#4200eed1',
  electricIndigoA12: '#180069e6',
};

export const electricIndigoP3 = {
  electricIndigo1: 'color(display-p3 0.9914 0.9917 1)',
  electricIndigo2: 'color(display-p3 0.9707 0.9716 1)',
  electricIndigo3: 'color(display-p3 0.9408 0.9422 1)',
  electricIndigo4: 'color(display-p3 0.8983 0.8995 1)',
  electricIndigo5: 'color(display-p3 0.8524 0.8522 1)',
  electricIndigo6: 'color(display-p3 0.7953 0.7919 1)',
  electricIndigo7: 'color(display-p3 0.7161 0.7042 1)',
  electricIndigo8: 'color(display-p3 0.6117 0.5789 1)',
  electricIndigo9: 'color(display-p3 0.3562 0.1176 0.9345)',
  electricIndigo10: 'color(display-p3 0.309 0 0.8658)',
  electricIndigo11: 'color(display-p3 0.3639 0.1927 0.9095)',
  electricIndigo12: 'color(display-p3 0.1733 0.1009 0.451)',
};

export const electricIndigoP3A = {
  electricIndigoA1: 'color(display-p3 0.0196 0.0196 1 / 0.008)',
  electricIndigoA2: 'color(display-p3 0.0196 0.1451 0.8784 / 0.032)',
  electricIndigoA3: 'color(display-p3 0.0039 0.0039 0.9373 / 0.059)',
  electricIndigoA4: 'color(display-p3 0.0039 0.0039 0.9255 / 0.102)',
  electricIndigoA5: 'color(display-p3 0.0078 0.0078 0.9216 / 0.146)',
  electricIndigoA6: 'color(display-p3 0.0039 0.0039 0.9255 / 0.204)',
  electricIndigoA7: 'color(display-p3 0.0314 0.0039 0.9333 / 0.291)',
  electricIndigoA8: 'color(display-p3 0.0706 0.0039 0.9373 / 0.416)',
  electricIndigoA9: 'color(display-p3 0.2706 0 0.9255 / 0.883)',
  electricIndigoA10: 'color(display-p3 0.2824 0 0.8588 / 0.957)',
...
export const limeGreenA = {
  limeGreenA1: '#00cc0005',
  limeGreenA2: '#16c0000c',
  limeGreenA3: '#16e20023',
  limeGreenA4: '#12e00039',
  limeGreenA5: '#10d30050',
  limeGreenA6: '#0dc30069',
  limeGreenA7: '#0ab30089',
  limeGreenA8: '#03af00bf',
  limeGreenA9: '#00d612f9',
  limeGreenA10: '#00cb00',
  limeGreenA11: '#008600',
  limeGreenA12: '#013000e7',
};

export const limeGreenP3 = {
  limeGreen1: 'color(display-p3 0.9836 0.9961 0.9805)',
  limeGreen2: 'color(display-p3 0.9614 0.9862 0.9553)',
  limeGreen3: 'color(display-p3 0.8945 0.9821 0.8729)',
  limeGreen4: 'color(display-p3 0.8269 0.9657 0.7927)',
  limeGreen5: 'color(display-p3 0.7545 0.9369 0.7099)',
  limeGreen6: 'color(display-p3 0.6723 0.8927 0.6185)',
  limeGreen7: 'color(display-p3 0.5673 0.8305 0.5032)',
  limeGreen8: 'color(display-p3 0.4126 0.7539 0.3277)',
  limeGreen9: 'color(display-p3 0.3843 0.8306 0.2661)',
  limeGreen10: 'color(display-p3 0.3386 0.7852 0.2155)',
  limeGreen11: 'color(display-p3 0.2169 0.5168 0.1352)',
  limeGreen12: 'color(display-p3 0.1424 0.2578 0.1142)',
};

export const limeGreenP3A = {
  limeGreenA1: 'color(display-p3 0.2157 0.8039 0.0196 / 0.02)',
  limeGreenA2: 'color(display-p3 0.1098 0.7333 0.0196 / 0.044)',
  limeGreenA3: 'color(display-p3 0.1882 0.851 0.0078 / 0.13)',
  limeGreenA4: 'color(display-p3 0.1725 0.851 0.0039 / 0.208)',
  limeGreenA5: 'color(display-p3 0.1647 0.7882 0.0039 / 0.291)',
  limeGreenA6: 'color(display-p3 0.149 0.7255 0.0039 / 0.381)',
  limeGreenA7: 'color(display-p3 0.1373 0.6627 0.0039 / 0.499)',
  limeGreenA8: 'color(display-p3 0.1294 0.6353 0 / 0.675)',
  limeGreenA9: 'color(display-p3 0.1608 0.7686 0 / 0.734)',
  limeGreenA10: 'color(display-p3 0.1686 0.7216 0 / 0.769)',
