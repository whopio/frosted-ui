...
export const lemonLimeDarkA = {
  lemonLimeA1: '#00910002',
  lemonLimeA2: '#bcf40009',
  lemonLimeA3: '#d1fb0718',
  lemonLimeA4: '#d2fb0025',
  lemonLimeA5: '#d8fc0032',
  lemonLimeA6: '#ddfd2141',
  lemonLimeA7: '#dffe3d53',
  lemonLimeA8: '#e2ff4469',
  lemonLimeA9: '#e3fe05f5',
  lemonLimeA10: '#e5fe51e8',
  lemonLimeA11: '#e4fe4ee5',
  lemonLimeA12: '#f0feb8f5',
};

export const lemonLimeDarkP3 = {
  lemonLime1: 'color(display-p3 0.0656 0.0703 0.044)',
  lemonLime2: 'color(display-p3 0.0916 0.098 0.0617)',
  lemonLime3: 'color(display-p3 0.1412 0.1537 0.0731)',
  lemonLime4: 'color(display-p3 0.1825 0.2001 0.0756)',
  lemonLime5: 'color(display-p3 0.226 0.2481 0.086)',
  lemonLime6: 'color(display-p3 0.2762 0.3016 0.1182)',
  lemonLime7: 'color(display-p3 0.3378 0.3671 0.1606)',
  lemonLime8: 'color(display-p3 0.4128 0.4482 0.1964)',
  lemonLime9: 'color(display-p3 0.8781 0.9576 0.3125)',
  lemonLime10: 'color(display-p3 0.842 0.9116 0.4038)',
  lemonLime11: 'color(display-p3 0.8302 0.8994 0.3913)',
  lemonLime12: 'color(display-p3 0.9183 0.9596 0.7245)',
};

export const lemonLimeDarkP3A = {
  lemonLimeA1: 'color(display-p3 0 0.8549 0 / 0.005)',
  lemonLimeA2: 'color(display-p3 0.7608 0.9922 0 / 0.034)',
  lemonLimeA3: 'color(display-p3 0.8706 0.9961 0.1529 / 0.093)',
  lemonLimeA4: 'color(display-p3 0.8627 1 0.1216 / 0.143)',
  lemonLimeA5: 'color(display-p3 0.8784 1 0.1686 / 0.194)',
  lemonLimeA6: 'color(display-p3 0.8902 0.9961 0.2706 / 0.253)',
  lemonLimeA7: 'color(display-p3 0.902 1 0.3608 / 0.324)',
  lemonLimeA8: 'color(display-p3 0.9059 1 0.3843 / 0.412)',
  lemonLimeA9: 'color(display-p3 0.9176 1 0.3255 / 0.954)',
  lemonLimeA10: 'color(display-p3 0.9216 0.9961 0.4392 / 0.904)',
  lemonLimeA11: 'color(display-p3 0.9216 1 0.4314 / 0.891)',
  lemonLimeA12: 'color(display-p3 0.9529 1 0.7529 / 0.958)',
};

export const electricIndigoDark = {
  electricIndigo1: '#100f1f',
  electricIndigo2: '#16142b',
  electricIndigo3: '#241a57',
  electricIndigo4: '#30177b',
  electricIndigo5: '#3a218d',
  electricIndigo6: '#432d9c',
  electricIndigo7: '#5039b3',
  electricIndigo8: '#6045d6',
  electricIndigo9: '#6318f8',
  electricIndigo10: '#5800e6',
  electricIndigo11: '#ada8ff',
  electricIndigo12: '#ddf',
};

export const electricIndigoDarkA = {
  electricIndigoA1: '#0000ff0f',
  electricIndigoA2: '#3f2dfe1c',
  electricIndigoA3: '#5230ff4b',
  electricIndigoA4: '#571fff72',
  electricIndigoA5: '#6030ff85',
  electricIndigoA6: '#6741ff95',
  electricIndigoA7: '#6e4cffae',
  electricIndigoA8: '#704ffed4',
  electricIndigoA9: '#6619fff8',
  electricIndigoA10: '#6000fee5',
  electricIndigoA11: '#ada8ff',
  electricIndigoA12: '#ddddff',
};

export const electricIndigoDarkP3 = {
  electricIndigo1: 'color(display-p3 0.0604 0.0576 0.1185)',
  electricIndigo2: 'color(display-p3 0.0833 0.0784 0.163)',
  electricIndigo3: 'color(display-p3 0.1353 0.1026 0.326)',
  electricIndigo4: 'color(display-p3 0.176 0.0967 0.4632)',
  electricIndigo5: 'color(display-p3 0.2121 0.1331 0.5303)',
  electricIndigo6: 'color(display-p3 0.251 0.1807 0.5884)',
  electricIndigo7: 'color(display-p3 0.3001 0.2284 0.6756)',
  electricIndigo8: 'color(display-p3 0.3613 0.2735 0.8079)',
  electricIndigo9: 'color(display-p3 0.3562 0.1176 0.9345)',
  electricIndigo10: 'color(display-p3 0.309 0 0.8658)',
  electricIndigo11: 'color(display-p3 0.6727 0.6534 1)',
  electricIndigo12: 'color(display-p3 0.8675 0.8681 1)',
};

export const electricIndigoDarkP3A = {
  electricIndigoA1: 'color(display-p3 0 0 0.9961 / 0.055)',
  electricIndigoA2: 'color(display-p3 0.2627 0.1843 1 / 0.101)',
  electricIndigoA3: 'color(display-p3 0.3059 0.1922 1 / 0.282)',
  electricIndigoA4: 'color(display-p3 0.3255 0.1333 1 / 0.425)',
  electricIndigoA5: 'color(display-p3 0.3529 0.1961 0.9961 / 0.5)',
  electricIndigoA6: 'color(display-p3 0.4 0.2706 1 / 0.559)',
  electricIndigoA7: 'color(display-p3 0.4275 0.3137 1 / 0.652)',
  electricIndigoA8: 'color(display-p3 0.4392 0.3294 1 / 0.795)',
  electricIndigoA9: 'color(display-p3 0.3804 0.1216 1 / 0.929)',
  electricIndigoA10: 'color(display-p3 0.3569 0.0431 1 / 0.858)',
  electricIndigoA11: 'color(display-p3 0.6902 0.6745 1 / 0.975)',
  electricIndigoA12: 'color(display-p3 0.8784 0.8784 1 / 0.988)',
};
