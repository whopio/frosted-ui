  ...
  return (
    <>
      ...
      <MenubarPrimitive.Root
        className={cn(
          'border-stroke flex h-10 flex-row items-center gap-1 rounded-md border bg-background p-1 shadow-sm shadow-black/5 sm:h-9',
          className
        )}
        ...
        <NativeOnlyAnimatedView
          ...
          <TextClassContext.Provider value="text-popover-foreground">
            <MenubarPrimitive.Content
              className={cn(
                'border-stroke min-w-[12rem] overflow-hidden rounded-md border bg-popover p-1 shadow-lg shadow-black/5',
                Platform.select({
                  web: cn(
