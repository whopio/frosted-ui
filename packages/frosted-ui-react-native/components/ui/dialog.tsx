    ...
    <DialogPortal hostName={portalHost}>
      <DialogOverlay>
        <DialogPrimitive.Content
          className={cn(
            'border-stroke z-50 mx-auto flex w-full max-w-[calc(100%-2rem)] flex-col gap-4 rounded-lg border bg-background p-6 shadow-lg shadow-black/5 sm:max-w-lg',
            Platform.select({
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      className={cn('text-gray-12 text-lg font-semibold leading-none', className)}
      {...props}
    />
  );
}
