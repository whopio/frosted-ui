...
export const DoubleArrowDownUpBold12 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    <svg
      ...
      data-fui-icon="DoubleArrowDownUpBold12"
      {...props}
    >
      <path
        d="M6.293 2.31c-.39.391-.39 1.024 0 1.415.39.39 1.023.39 1.414 0L8 3.432V11c0 .552.448 1 1 1s1-.448 1-1V3.432l.293.293c.39.39 1.023.39 1.414 0 .39-.39.39-1.024 0-1.414l-2-2c-.39-.39-1.024-.39-1.414 0l-2 2zm-6 5.982c-.39.39-.39 1.024 0 1.414l2 2.001c.39.39 1.023.39 1.414 0l2-2.001c.391-.39.391-1.024 0-1.414-.39-.39-1.023-.39-1.413 0L4 8.586V1c0-.552-.448-1-1-1S2 .448 2 1v7.585l-.293-.293c-.39-.39-1.024-.39-1.414 0z"
        fill={color}
        fillRule="evenodd"
        clipRule="evenodd"
      />
