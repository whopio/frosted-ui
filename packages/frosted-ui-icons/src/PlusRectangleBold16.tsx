...
export const PlusRectangleBold16 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    <svg
      ...
      data-fui-icon="PlusRectangleBold16"
      {...props}
    >
      <path
        d="M10.5 1C12.985 1 15 3.015 15 5.5v5c0 2.485-2.015 4.5-4.5 4.5h-5C3.015 15 1 12.985 1 10.5v-5C1 3.015 3.015 1 5.5 1h5zm-5 2C4.12 3 3 4.12 3 5.5v5C3 11.88 4.12 13 5.5 13h5c1.38 0 2.5-1.12 2.5-2.5v-5C13 4.12 11.88 3 10.5 3h-5zM8 4c.552 0 1 .448 1 1v2h2c.552 0 1 .448 1 1s-.448 1-1 1H9v2c0 .552-.448 1-1 1s-1-.448-1-1V9H5c-.552 0-1-.448-1-1s.448-1 1-1h2V5c0-.552.448-1 1-1z"
        fill={color}
      />
    </svg>
  );
