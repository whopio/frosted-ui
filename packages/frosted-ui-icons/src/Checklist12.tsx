...
export const Checklist12 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    ...
    >
      <path
        d="M7.499 0c.69 0 1.251.559 1.251 1.25v.25C9.993 1.5 11 2.507 11 3.75v6C11 10.993 9.993 12 8.75 12h-5.5C2.007 12 1 10.993 1 9.75v-6C1 2.507 2.007 1.5 3.25 1.5v-.25C3.25.559 3.812 0 4.501 0h2.998zM3.25 3c-.414 0-.75.336-.75.75v6c0 .414.336.75.75.75h5.5c.414 0 .75-.336.75-.75v-6c0-.414-.336-.75-.75-.75h-.025c-.116.57-.62 1-1.225 1h-3c-.605 0-1.109-.43-1.225-1H3.25zm3.97 2.22c.293-.293.767-.293 1.06 0 .293.293.293.767 0 1.06l-2.5 2.5c-.293.293-.767.293-1.06 0l-1-1c-.293-.293-.293-.767 0-1.06.293-.293.767-.293 1.06 0l.47.47 1.97-1.97zM4.75 2.5h2.5v-1h-2.5v1z"
        fill={color}
      />
    </svg>
  );
