...
export const DashboardBarGraph16 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    <svg
      ...
      data-fui-icon="DashboardBarGraph16"
      {...props}
    >
      <path
        d="M11.75 0C14.097 0 16 1.903 16 4.25v7.5c0 2.347-1.903 4.25-4.25 4.25h-7.5C1.903 16 0 14.097 0 11.75v-7.5C0 1.903 1.903 0 4.25 0h7.5zm-7.5 1.5C2.73 1.5 1.5 2.731 1.5 4.25v7.5c0 1.519 1.231 2.75 2.75 2.75h7.5c1.518 0 2.75-1.231 2.75-2.75v-7.5c0-1.518-1.232-2.75-2.75-2.75h-7.5zm.5 6.5c.414 0 .75.336.75.75v2.5c0 .414-.336.75-.75.75S4 11.664 4 11.25v-2.5c0-.414.336-.75.75-.75zM8 4c.414 0 .75.336.75.75v6.5c0 .414-.336.75-.75.75s-.75-.336-.75-.75v-6.5c0-.414.336-.75.75-.75zm3.25 1.75c.414 0 .75.336.75.75v4.75c0 .414-.336.75-.75.75s-.75-.336-.75-.75V6.5c0-.414.336-.75.75-.75z"
        fill={color}
      />
    </svg>
  );
