...
export const CalendarBoldFilled24 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    <svg
      width="24"
      height="24"
      ...
      data-fui-icon="CalendarBoldFilled24"
      {...props}
    >
      <path
...
CalendarBoldFilled24.category = 'Interface General';

export default CalendarBoldFilled24;
