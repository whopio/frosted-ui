...
export const LightsOffFilled12 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    <svg
      ...
      data-fui-icon="LightsOffFilled12"
      {...props}
    >
      <path
        d="M7 10.5c.414 0 .75.336.75.75S7.414 12 7 12H5c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h2zM6 2.25c1.204 0 2.161.459 2.81 1.19.637.716.94 1.65.94 2.56 0 1.415-.967 2.166-1.518 2.48-.104.718-.72 1.27-1.467 1.27h-1.53c-.747 0-1.364-.552-1.468-1.27C3.217 8.166 2.25 7.414 2.25 6c0-.91.303-1.844.94-2.56.649-.731 1.606-1.19 2.81-1.19z"
        fill={color}
      />
    </svg>
  );
