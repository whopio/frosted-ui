  ...
  ({ color = 'currentColor', ...props }, forwardedRef) => {
    return (
      ...
      >
        ...
        />
        <path
          d="M22.25 12.25C22.25 12.25 21 9.75001 17.125 9.75001C13.25 9.75001 12 12.25 12 12.25C12 12.25 10.7501 9.75 6.87515 9.75C3.00015 9.75 1.75015 12.25 1.75015 12.25"
          stroke={color}
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
