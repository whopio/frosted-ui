...
export const MicrophoneNoBaseFilled24 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    <svg
      ...
      data-fui-icon="MicrophoneNoBaseFilled24"
      {...props}
    >
      <path
        d="M21 10.75C21.414 10.7503 21.75 11.0859 21.75 11.5C21.75 16.5138 17.9647 20.6402 13.0964 21.1852C12.9016 21.207 12.75 21.3692 12.75 21.5653V23.25C12.75 23.6641 12.414 23.9997 12 24C11.5858 24 11.25 23.6642 11.25 23.25V21.5653C11.25 21.3693 11.0984 21.207 10.9036 21.1852C6.03505 20.6404 2.25 16.514 2.25 11.5C2.25 11.0858 2.58579 10.75 3 10.75C3.41399 10.7503 3.75 11.0859 3.75 11.5C3.75 16.0563 7.44365 19.75 12 19.75C16.5561 19.7497 20.25 16.0562 20.25 11.5C20.25 11.0858 20.5858 10.75 21 10.75ZM12 0C15.3135 0.000263871 18 2.68645 18 6V11.5C18 14.8135 15.3135 17.4997 12 17.5C8.68629 17.5 6 14.8137 6 11.5V6C6 2.68629 8.68629 0 12 0Z"
        fill={color}
        fillRule="evenodd"
        clipRule="evenodd"
      />
