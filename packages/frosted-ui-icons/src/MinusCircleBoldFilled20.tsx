...
export const MinusCircleBoldFilled20 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    ...
    >
      <path
        d="M10 0.5C15.2467 0.5 19.5 4.75329 19.5 10C19.5 15.2467 15.2467 19.5 10 19.5C4.75329 19.5 0.5 15.2467 0.5 10C0.5 4.75329 4.75329 0.5 10 0.5ZM6.75 8.95898C6.19783 8.95898 5.75018 9.40685 5.75 9.95898C5.75 10.5113 6.19772 10.959 6.75 10.959H13.25C13.8023 10.959 14.25 10.5113 14.25 9.95898C14.2498 9.40685 13.8022 8.95898 13.25 8.95898H6.75Z"
        fill={color}
      />
    </svg>
  );
