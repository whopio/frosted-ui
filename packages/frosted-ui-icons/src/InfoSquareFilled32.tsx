...
export const InfoSquareFilled32 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    <svg
      ...
      data-fui-icon="InfoSquareFilled32"
      {...props}
    >
      <path
        d="M22.75 1C27.306 1 31 4.694 31 9.25v13.5c0 4.556-3.694 8.25-8.25 8.25H9.25C4.694 31 1 27.306 1 22.75V9.25C1 4.694 4.694 1 9.25 1h13.5zm-6.749 12c-.414 0-.75.336-.75.75v9.5c0 .414.336.75.75.75s.75-.336.75-.75v-9.5c0-.414-.336-.75-.75-.75zm0-5c-.69 0-1.25.56-1.251 1.25 0 .69.56 1.25 1.251 1.25.69 0 1.25-.56 1.25-1.25S16.691 8 16.001 8z"
        fill={color}
      />
    </svg>
  );
