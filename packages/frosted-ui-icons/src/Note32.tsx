...
export const Note32 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    <svg
      ...
      data-fui-icon="Note32"
      {...props}
    >
      <path
        d="M22.75 1C27.306 1 31 4.694 31 9.25v13.5c0 4.556-3.694 8.25-8.25 8.25H9.25C4.694 31 1 27.306 1 22.75V9.25C1 4.694 4.694 1 9.25 1h13.5zM9.25 2.5C5.522 2.5 2.5 5.522 2.5 9.25v13.5c0 3.728 3.022 6.75 6.75 6.75h13.5c3.728 0 6.75-3.022 6.75-6.75V9.25c0-3.728-3.022-6.75-6.75-6.75H9.25zM16 21.25c.414 0 .75.336.75.75s-.336.75-.75.75H9c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h7zm7-6c.414 0 .75.336.75.75s-.336.75-.75.75H9c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h14zm0-6c.414 0 .75.336.75.75s-.336.75-.75.75H9c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h14z"
        fill={color}
      />
    </svg>
  );
