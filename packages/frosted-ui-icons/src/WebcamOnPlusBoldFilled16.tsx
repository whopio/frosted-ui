...
export const WebcamOnPlusBoldFilled16 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    ...
    >
      <path
        d="M8 2.25C9.60561 2.25 10.9892 3.19648 11.626 4.56152L11.9854 4.23438L12.0957 4.14062C13.255 3.23147 14.9988 4.04813 14.999 5.56348V10.4365C14.9988 12.0008 13.1406 12.8204 11.9854 11.7656L11.626 11.4375C10.9894 12.803 9.60592 13.75 8 13.75H5C2.79086 13.75 1 11.9591 1 9.75V6.25C1 4.04086 2.79086 2.25 5 2.25H8ZM6.5 5C5.94772 5 5.5 5.44772 5.5 6V7H4.5C3.94772 7 3.5 7.44772 3.5 8C3.5 8.55228 3.94772 9 4.5 9H5.5V10C5.5 10.5523 5.94772 11 6.5 11C7.05228 11 7.5 10.5523 7.5 10V9H8.5C9.05228 9 9.5 8.55228 9.5 8C9.5 7.44772 9.05228 7 8.5 7H7.5V6C7.5 5.44772 7.05228 5 6.5 5Z"
        fill={color}
      />
    </svg>
  );
