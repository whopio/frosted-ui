...
export const UploadBoldFilled16 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    ...
    >
      <path
        d="M13.75 12.2504C14.5784 12.2504 15.25 12.922 15.25 13.7504C15.2498 14.5787 14.5783 15.2504 13.75 15.2504H2.25C1.42173 15.2504 0.750215 14.5787 0.75 13.7504C0.75 12.922 1.42159 12.2505 2.25 12.2504H13.75ZM8 0.750427C8.39781 0.75044 8.77925 0.908587 9.06055 1.18988L12.8105 4.93988C13.3961 5.52567 13.3962 6.47525 12.8105 7.06097C12.2248 7.64647 11.2752 7.64649 10.6895 7.06097L9.5 5.87152V10.0004C9.49979 10.8287 8.82827 11.5004 8 11.5004C7.17173 11.5004 6.50022 10.8287 6.5 10.0004V5.87152L5.31055 7.06097C4.72481 7.64647 3.77518 7.64649 3.18945 7.06097C2.60374 6.47526 2.60389 5.52568 3.18945 4.93988L6.93945 1.18988L7.04883 1.09027C7.31579 0.871392 7.65176 0.750438 8 0.750427Z"
        fill={color}
      />
    </svg>
  );
