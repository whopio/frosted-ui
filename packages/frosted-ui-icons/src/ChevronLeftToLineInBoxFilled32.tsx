...
export const ChevronLeftToLineInBoxFilled32 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    <svg
      ...
      data-fui-icon="ChevronLeftToLineInBoxFilled32"
      {...props}
    >
      <path
        d="M22.75 1C27.306 1 31 4.694 31 9.25v13.5c0 4.556-3.694 8.25-8.25 8.25H9.25C4.694 31 1 27.306 1 22.75V9.25C1 4.694 4.694 1 9.25 1h13.5zm.03 8.22c-.293-.293-.767-.293-1.06 0l-6.25 6.25c-.14.14-.22.331-.22.53s.08.39.22.53l6.5 6.5c.293.293.767.293 1.06 0 .293-.293.293-.767 0-1.06L17.06 16l5.72-5.72c.293-.293.293-.767 0-1.06zM10.75 9c-.414 0-.75.336-.75.75v12.5c0 .414.336.75.75.75s.75-.336.75-.75V9.75c0-.414-.336-.75-.75-.75z"
        fill={color}
      />
    </svg>
  );
