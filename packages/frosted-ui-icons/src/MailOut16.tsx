...
export const MailOut16 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M.75 4.5L6.02132 8.04865C6.45834 8.34285 6.97318 8.5 7.5 8.5 8.02682 8.5 8.54166 8.34285 8.97868 8.04865L14.25 4.5M13 8.125L15.25 10.25 13 12.375M10 10.25H15.25"
        stroke={color}
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
