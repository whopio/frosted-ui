...
export const CouponBoldFilled24 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    <svg
      ...
      data-fui-icon="CouponBoldFilled24"
      {...props}
    >
      <path
        d="M7.082 0c.955 0 1.648.654 1.954 1.333C9.546 2.465 10.682 3.25 12 3.25s2.454-.785 2.964-1.917C15.27.654 15.964 0 16.918 0H18.5C20.433 0 22 1.567 22 3.5v17c0 1.933-1.567 3.5-3.5 3.5h-1.582c-.955 0-1.648-.654-1.954-1.333-.51-1.132-1.646-1.917-2.964-1.917s-2.454.785-2.964 1.917c-.306.679-1 1.333-1.954 1.333H5.5C3.567 24 2 22.433 2 20.5v-17C2 1.567 3.567 0 5.5 0h1.582z"
        fill={color}
      />
    </svg>
  );
