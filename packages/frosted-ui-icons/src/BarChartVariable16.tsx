...
export const BarChartVariable16 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    <svg
      width="16"
      height="16"
      ...
      data-fui-icon="BarChartVariable16"
      {...props}
    >
      <path
...
BarChartVariable16.category = 'Stats & Charts';

export default BarChartVariable16;
