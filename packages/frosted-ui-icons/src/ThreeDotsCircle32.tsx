  ...
  ({ color = 'currentColor', ...props }, forwardedRef) => {
    return (
      ...
      >
        ...
        />
        <path
          d="M28.3334 16C28.3334 22.8115 22.8115 28.3333 16 28.3333C9.18851 28.3333 3.66669 22.8115 3.66669 16C3.66669 9.18848 9.18851 3.66666 16 3.66666C22.8115 3.66666 28.3334 9.18848 28.3334 16Z"
          stroke={color}
          strokeWidth="1.5"
        />
      </svg>
