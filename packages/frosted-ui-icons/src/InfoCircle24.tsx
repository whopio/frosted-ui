...
export const InfoCircle24 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    ...
    >
      <path
        d="M12 .5C18.351.5 23.5 5.649 23.5 12S18.351 23.5 12 23.5.5 18.351.5 12 5.649.5 12 .5zM12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm.001 8.25c.414 0 .75.336.75.75v6.25c0 .414-.336.75-.75.75s-.75-.336-.75-.75V11c0-.414.336-.75.75-.75zm0-4.25c.607 0 1.1.493 1.1 1.1 0 .607-.493 1.099-1.1 1.1-.607 0-1.1-.493-1.1-1.1 0-.608.493-1.1 1.1-1.1z"
        fill={color}
      />
    </svg>
  );
