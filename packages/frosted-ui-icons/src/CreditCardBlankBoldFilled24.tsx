...
export const CreditCardBlankBoldFilled24 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    ...
    >
      <path
        d="M24 16C24 19.3137 21.3137 22 18 22H6C2.68629 22 0 19.3137 0 16V10H24V16ZM18 2C20.9729 2 23.4388 4.16245 23.915 7H0.0849609C0.561174 4.16245 3.02712 2 6 2H18Z"
        fill={color}
      />
    </svg>
  );
