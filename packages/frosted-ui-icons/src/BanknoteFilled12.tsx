...
export const BanknoteFilled12 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    <svg
      ...
      data-fui-icon="BanknoteFilled12"
      {...props}
    >
      <path
        d="M9.25 1C10.769 1 12 2.231 12 3.75v4.5C12 9.769 10.769 11 9.25 11h-6.5C1.231 11 0 9.769 0 8.25v-4.5C0 2.231 1.231 1 2.75 1h6.5zm0 6.5c-.414 0-.75.336-.75.75s.336.75.75.75.75-.336.75-.75-.336-.75-.75-.75zM6 4c-1.105 0-2 .895-2 2s.895 2 2 2 2-.895 2-2-.895-2-2-2zM2.75 3c-.414 0-.75.336-.75.75s.336.75.75.75.75-.336.75-.75S3.164 3 2.75 3z"
        fill={color}
      />
    </svg>
  );
