    ...
    return (
      ...
      >
        <g clipPath="url(#clip0_1679_667)">
          <path
            d="M2.25003 0.75C1.4216 0.75 0.750031 1.42157 0.750031 2.25V9.75C0.750031 10.5784 1.4216 11.25 2.25003 11.25H9.75003C10.5785 11.25 11.25 10.5784 11.25 9.75V2.25C11.25 1.42157 10.5785 0.75 9.75003 0.75H2.25003Z"
            stroke={color}
            strokeWidth="1.5"
          />
          <path
