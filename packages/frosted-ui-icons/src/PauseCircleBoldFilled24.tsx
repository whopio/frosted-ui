...
export const PauseCircleBoldFilled24 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    <svg
      width="24"
      height="24"
      ...
      data-fui-icon="PauseCircleBoldFilled24"
      {...props}
    >
      <path
...
PauseCircleBoldFilled24.category = 'Sound & Music';

export default PauseCircleBoldFilled24;
