...
export const InfoCircleBoldFilled12 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    ...
    >
      <path
        d="M6 0.25C9.17564 0.25 11.75 2.82436 11.75 6C11.75 9.17564 9.17564 11.75 6 11.75C2.82436 11.75 0.25 9.17564 0.25 6C0.25 2.82436 2.82436 0.25 6 0.25ZM6 5.5C5.44772 5.5 5 5.94772 5 6.5V8C5 8.55228 5.44772 9 6 9C6.55228 9 7 8.55228 7 8V6.5C7 5.94772 6.55228 5.5 6 5.5ZM6 3C5.50299 3.00005 5.10059 3.40337 5.10059 3.90039C5.1008 4.39723 5.50312 4.79975 6 4.7998C6.49693 4.7998 6.90018 4.39727 6.90039 3.90039C6.90039 3.40333 6.49706 3 6 3Z"
        fill={color}
      />
    </svg>
  );
