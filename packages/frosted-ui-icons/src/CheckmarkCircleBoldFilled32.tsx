...
export const CheckmarkCircleBoldFilled32 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    ...
    >
      <path
        d="M16 1C24.2843 1 31 7.71573 31 16C31 24.2843 24.2843 31 16 31C7.71573 31 1 24.2843 1 16C1 7.71573 7.71573 1 16 1ZM23.3105 10.9395C22.7248 10.3537 21.7752 10.3537 21.1895 10.9395L13.6201 18.5088L10.8105 15.6992C10.2248 15.1135 9.27523 15.1135 8.68945 15.6992C8.10367 16.285 8.10372 17.2345 8.68945 17.8203L12.5596 21.6904C12.8409 21.9717 13.2223 22.1299 13.6201 22.1299C14.0179 22.1299 14.3994 21.9717 14.6807 21.6904L23.3105 13.0605C23.8963 12.4748 23.8963 11.5252 23.3105 10.9395Z"
        fill={color}
      />
    </svg>
  );
