...
export const InfoCircleBold20 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    ...
    >
      <path
        d="M10 .5c5.247 0 9.5 4.253 9.5 9.5s-4.253 9.5-9.5 9.5S.5 15.247.5 10 4.753.5 10 .5zm0 2c-4.142 0-7.5 3.358-7.5 7.5 0 4.142 3.358 7.5 7.5 7.5 4.142 0 7.5-3.358 7.5-7.5 0-4.142-3.358-7.5-7.5-7.5zm0 6c.552 0 1 .448 1 1V14c0 .552-.448 1-1 1s-1-.448-1.001-1V9.5c0-.552.449-1 1.001-1zM10 5c.552 0 1 .448 1 1s-.448 1-1 1-1-.448-1.001-1c0-.552.449-1 1.001-1z"
        fill={color}
      />
    </svg>
  );
