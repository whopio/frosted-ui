...
export const MailOut32 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M.75 10.3991L11.0974 17.3641C11.9552 17.9415 12.9659 18.25 14 18.25 15.0341 18.25 16.0448 17.9415 16.9026 17.3641L27.25 10.3991M19.75 21.75H31.25M31.25 21.75L26.75 17.5M31.25 21.75L26.75 26"
        stroke={color}
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
