...
export const InfoCircleBoldFilled24 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    ...
    >
      <path
        d="M12 0.5C18.3513 0.5 23.5 5.64873 23.5 12C23.5 18.3513 18.3513 23.5 12 23.5C5.64873 23.5 0.5 18.3513 0.5 12C0.5 5.64873 5.64873 0.5 12 0.5ZM12.001 10.25C11.3107 10.25 10.7512 10.8098 10.751 11.5V17C10.7512 17.6902 11.3107 18.25 12.001 18.25C12.691 18.2497 13.2508 17.69 13.251 17V11.5C13.2508 10.81 12.691 10.2503 12.001 10.25ZM12 5.75C11.3098 5.75 10.7502 6.30981 10.75 7C10.7502 7.69019 11.3098 8.25 12 8.25C12.6902 8.25 13.2498 7.69019 13.25 7C13.2498 6.30981 12.6902 5.75 12 5.75Z"
        fill={color}
      />
    </svg>
  );
