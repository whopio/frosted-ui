...
export const BarsLightPictogram = (props: PictogramProps) => {
  return (
    <svg
      width="240"
      height="240"
    ...
    >
      ...
      <path d="M65.2217 127.127V172.985L89.9212 187.473L89.7135 140.417L65.2217 127.127Z" fill="#FA4616" />
      <path d="M82.416 118.827L65.2217 127.126L89.7135 140.416L106.341 131.414L82.416 118.827Z" fill="#E7552F" />
...
BarsLightPictogram.category = 'Pictograms';

export default BarsLightPictogram;
