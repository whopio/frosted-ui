...
export const BarChartPictogram = ({ variant = 'auto', ...props }: BarChartPictogramProps) => {
  ...
  return (
    ...
    >
      ...
      <path d="M163.279 163.843L180.4 155.774V51.6577L163.055 61.0487L163.279 163.843Z" style={{ fill: f[3] }} />
      ...
      <path d="M126.128 177.767L142.547 170.03V96.9507L125.92 105.953L126.128 177.767Z" style={{ fill: f[6] }} />
      ...
      <path
        ...
        style={{ fill: f[8] }}
      />
      <path d="M89.9206 187.473L106.34 179.737V131.415L89.7129 140.417L89.9206 187.473Z" style={{ fill: f[9] }} />
      <path d="M52.1914 173.333V191.997L105.43 221.211L105.149 202.644L52.1914 173.333Z" fill="#B6B5B0" />
      <path d="M192.3 154.485L105.15 202.644L105.431 221.213L192.3 172.632V154.485Z" style={{ fill: f[11] }} />
    </svg>
  );
};
