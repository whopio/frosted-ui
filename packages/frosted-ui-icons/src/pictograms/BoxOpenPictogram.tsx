...
export const BoxOpenPictogram = ({ variant = 'auto', ...props }: BoxOpenPictogramProps) => {
  ...
  return (
    ...
    >
      ...
      <path d="M117.241 65.03l-57.03 34.048 62.082 34.113 58.67-38.345-63.722-29.817z" style={{ fill: f[6] }} />
      <path d="M132.321 185.765v3.753l20.466-12.929v-3.516l-20.466 12.692z" style={{ fill: f[7] }} />
      <path
...
BoxOpenPictogram.category = 'Pictograms';

export default BoxOpenPictogram;
