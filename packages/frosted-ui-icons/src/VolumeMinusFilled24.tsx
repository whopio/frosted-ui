...
export const VolumeMinusFilled24 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    <svg
      ...
      data-fui-icon="VolumeMinusFilled24"
      {...props}
    >
      <path
        d="M9.78613 1.68243C11.3813 0.180406 13.9999 1.31158 14 3.50274V20.4979C13.9998 22.6891 11.3813 23.8197 9.78613 22.3172L5.78027 18.5447C5.40932 18.1954 4.91875 17.9999 4.40918 17.9998H3.25C1.45507 17.9998 0 16.5447 0 14.7498V9.24981C0.000233069 7.45508 1.45522 5.99981 3.25 5.99981H4.40918C4.91878 5.9997 5.40932 5.80529 5.78027 5.45586L9.78613 1.68243ZM23.25 11.2498C23.6641 11.2498 23.9998 11.5858 24 11.9998C24 12.414 23.6642 12.7498 23.25 12.7498H18.25C17.8358 12.7498 17.5 12.414 17.5 11.9998C17.5002 11.5858 17.8359 11.2498 18.25 11.2498H23.25Z"
        fill={color}
        fillRule="evenodd"
        clipRule="evenodd"
      />
