...
export const WebcamOnPlus20 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    <svg
      width="20"
      height="20"
...
WebcamOnPlus20.category = 'Interface General';

export default WebcamOnPlus20;
