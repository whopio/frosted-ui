...
export const MinusCircleBoldFilled32 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    ...
    >
      <path
        d="M16 .5C24.56.5 31.5 7.44 31.5 16c0 8.56-6.94 15.5-15.5 15.5C7.44 31.5.5 24.56.5 16 .5 7.44 7.44.5 16 .5zM9.75 15c-.552 0-1 .448-1 1s.448 1 1 1h12.5c.552 0 1-.448 1-1s-.448-1-1-1H9.75z"
        fill={color}
      />
    </svg>
  );
