...
export const CouponExpiredFilled24 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    <svg
      ...
      data-fui-icon="CouponExpiredFilled24"
      {...props}
    >
      <path
        d="M7.408 0C8.314 0 8.947.669 9.2 1.327 9.633 2.453 10.724 3.25 12 3.25c1.276 0 2.367-.797 2.8-1.923C15.053.67 15.686 0 16.592 0h2.158C20.545 0 22 1.455 22 3.25v17.5c0 1.795-1.455 3.25-3.25 3.25h-2.158c-.906 0-1.539-.669-1.792-1.327-.433-1.126-1.524-1.923-2.8-1.923-1.276 0-2.367.797-2.8 1.923C8.947 23.33 8.314 24 7.408 24H5.25C3.455 24 2 22.545 2 20.75V3.25C2 1.455 3.455 0 5.25 0h2.158zm8.497 8.1c-.293-.293-.767-.293-1.06 0L12 10.944 9.155 8.1c-.293-.293-.767-.293-1.06 0-.293.292-.293.767 0 1.06l2.845 2.845-2.845 2.845c-.293.293-.293.767 0 1.06.293.293.767.293 1.06 0L12 13.065l2.845 2.845c.293.293.767.293 1.06 0 .293-.293.293-.768 0-1.06l-2.845-2.845 2.845-2.845c.293-.293.293-.768 0-1.06z"
        fill={color}
      />
    </svg>
  );
