...
export const InfoSquareFilled12 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    ...
    >
      <path
        d="M8.25 0C10.3211 0 12 1.67893 12 3.75V8.25C12 10.3211 10.3211 12 8.25 12H3.75C1.67893 12 0 10.3211 0 8.25V3.75C0 1.67893 1.67893 1.28851e-07 3.75 0H8.25ZM6 5.5C5.58579 5.5 5.25 5.83579 5.25 6.25V8.25C5.25005 8.66417 5.58582 9 6 9C6.41418 9 6.74995 8.66417 6.75 8.25V6.25C6.75 5.83579 6.41421 5.5 6 5.5ZM6 2.75C5.50294 2.75 5.09961 3.15333 5.09961 3.65039C5.09982 4.14727 5.50307 4.5498 6 4.5498C6.49693 4.5498 6.90018 4.14727 6.90039 3.65039C6.90039 3.15333 6.49706 2.75 6 2.75Z"
        fill={color}
      />
    </svg>
  );
