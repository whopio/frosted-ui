...
export const ThreeDotsVerticalBoldFilled12 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    <svg
      width="12"
      height="12"
      ...
      data-fui-icon="ThreeDotsVerticalBoldFilled12"
      {...props}
    >
      <path
...
ThreeDotsVerticalBoldFilled12.category = 'Interface General';

export default ThreeDotsVerticalBoldFilled12;
