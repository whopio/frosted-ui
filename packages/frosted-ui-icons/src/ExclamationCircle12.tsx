...
export const ExclamationCircle12 = ({
  color = 'currentColor',
  ...props
}: IconProps) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M6.75 8C6.75 8.41421 6.41421 8.75 6 8.75C5.58579 8.75 5.25 8.41421 5.25 8C5.25 7.58579 5.58579 7.25 6 7.25C6.41421 7.25 6.75 7.58579 6.75 8Z"
        fill={color}
      />
      <path
