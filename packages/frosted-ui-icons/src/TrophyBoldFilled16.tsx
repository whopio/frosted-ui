...
export const TrophyBoldFilled16 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    <svg
      width="16"
      height="16"
...
TrophyBoldFilled16.category = 'Objects';

export default TrophyBoldFilled16;
