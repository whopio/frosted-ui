...
export const WebcamOnPlus12 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    ...
    >
      <path
        d="M6 1.5C7.34388 1.5 8.4815 2.3836 8.86328 3.60156L10 2.75C10.824 2.13197 12 2.71994 12 3.75V8.25C12 9.28006 10.824 9.86803 10 9.25L8.86328 8.39746C8.48177 9.61588 7.34421 10.5 6 10.5H3C1.34315 10.5 0 9.15685 0 7.5V4.5C0 2.84315 1.34315 1.5 3 1.5H6ZM3 3C2.17157 3 1.5 3.67157 1.5 4.5V7.5C1.5 8.32843 2.17157 9 3 9H6C6.82843 9 7.5 8.32843 7.5 7.5V4.5C7.5 3.67157 6.82843 3 6 3H3ZM4.5 3.75C4.91421 3.75 5.25 4.08579 5.25 4.5V5.25H6C6.41421 5.25 6.75 5.58579 6.75 6C6.75 6.41421 6.41421 6.75 6 6.75H5.25V7.5C5.25 7.91421 4.91421 8.25 4.5 8.25C4.08579 8.25 3.75 7.91421 3.75 7.5V6.75H3C2.58579 6.75 2.25 6.41421 2.25 6C2.25 5.58579 2.58579 5.25 3 5.25H3.75V4.5C3.75 4.08579 4.08579 3.75 4.5 3.75ZM9 5.37402V6.625L10.5 7.74902V4.25L9 5.37402Z"
        fill={color}
      />
    </svg>
  );
