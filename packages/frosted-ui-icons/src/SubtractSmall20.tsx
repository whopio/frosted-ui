...
export const SubtractSmall20 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    ...
    >
      <path
        d="M15.25 9.25C15.6642 9.25 16 9.58579 16 10C16 10.4142 15.6642 10.75 15.25 10.75H4.75C4.33579 10.75 4 10.4142 4 10C4 9.58579 4.33579 9.25 4.75 9.25H15.25Z"
        fill={color}
      />
    </svg>
  );
