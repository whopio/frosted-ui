...
export const CouponBoldFilled32 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    <svg
      ...
      data-fui-icon="CouponBoldFilled32"
      {...props}
    >
      <path
        d="M9.951 0c.92 0 1.62.61 1.928 1.309C12.576 2.895 14.16 4 16 4c1.84 0 3.424-1.105 4.121-2.691C20.428.61 21.13 0 22.05 0H25c2.21 0 4 1.79 4 4v24c0 2.21-1.79 4-4 4h-2.951c-.92 0-1.62-.61-1.928-1.309C19.424 29.105 17.84 28 16 28c-1.84 0-3.424 1.105-4.121 2.691C11.572 31.39 10.87 32 9.95 32H7c-2.21 0-4-1.79-4-4V4c0-2.21 1.79-4 4-4h2.951z"
        fill={color}
      />
    </svg>
  );
