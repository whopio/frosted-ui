...
export const AppleWalletBold32 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    <svg
      ...
      data-fui-icon="AppleWalletBold32"
      {...props}
    >
      <path
        d="M26 3.75c2.9 0 5.25 2.35 5.25 5.25v13c0 2.9-2.35 5.25-5.25 5.25H6C3.1 27.25.75 24.9.75 22V9C.75 6.1 3.1 3.75 6 3.75h20zM2.75 22c0 1.795 1.455 3.25 3.25 3.25h20c1.795 0 3.25-1.455 3.25-3.25v-4.75h-5.453c-.348 0-.69.091-.992.264l-4.82 2.754c-1.23.702-2.74.702-3.97 0l-4.82-2.754c-.302-.173-.644-.264-.992-.264H2.75V22zM6 5.75C4.205 5.75 2.75 7.205 2.75 9v6.25h5.453c.696 0 1.38.182 1.985.527l4.82 2.754c.615.352 1.37.352 1.984 0l4.82-2.754c.605-.345 1.289-.527 1.985-.527h5.453V9c0-1.795-1.455-3.25-3.25-3.25H6z"
        fill={color}
        fillRule="evenodd"
        clipRule="evenodd"
      />
