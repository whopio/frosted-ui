...
export const Dna12 = React.forwardRef<SVGSVGElement, IconProps>(
  ({ color = 'currentColor', ...props }, forwardedRef) => {
    return (
      ...
      >
        <path
          d="M5.99995 6C4.54169 4.89473 2.25 3.79011 2.25.75M9.74999 11.25C9.74999 9.37415 8.87742 8.2352 7.86652 7.3783M9.375 2.25L2.625 2.25M2.625 9.75L9.375 9.75"
          stroke={color}
          strokeWidth="1.5"
          strokeLinecap="round"
        />
