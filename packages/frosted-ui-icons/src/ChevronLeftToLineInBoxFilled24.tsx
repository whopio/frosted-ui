...
export const ChevronLeftToLineInBoxFilled24 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    <svg
      ...
      data-fui-icon="ChevronLeftToLineInBoxFilled24"
      {...props}
    >
      <path
        d="M17.5 0C21.09 0 24 2.91 24 6.5v11c0 3.59-2.91 6.5-6.5 6.5h-11C2.91 24 0 21.09 0 17.5v-11C0 2.91 2.91 0 6.5 0h11zM7.75 6.5c-.414 0-.75.336-.75.75v9.5c0 .414.336.75.75.75s.75-.336.75-.75v-9.5c0-.414-.336-.75-.75-.75zm9.53.22c-.293-.293-.767-.293-1.06 0l-4.75 4.75c-.14.14-.22.331-.22.53s.08.39.22.53l4.75 4.75c.293.293.767.293 1.06 0 .293-.293.293-.767 0-1.06L13.06 12l4.22-4.22c.293-.293.293-.767 0-1.06z"
        fill={color}
      />
    </svg>
  );
