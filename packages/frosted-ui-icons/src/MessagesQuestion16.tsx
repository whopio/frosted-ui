  ...
  ({ color = 'currentColor', ...props }, forwardedRef) => {
    return (
      ...
      >
        ...
        />
        <path
          d="M6.22266 10.4275C6.22266 10.7408 6.4766 10.9947 6.78984 10.9947C7.10308 10.9947 7.35702 10.7408 7.35702 10.4275C7.35702 10.1143 7.10308 9.86035 6.78984 9.86035C6.4766 9.86035 6.22266 10.1143 6.22266 10.4275Z"
          fill={color}
        />
      </svg>
    );
