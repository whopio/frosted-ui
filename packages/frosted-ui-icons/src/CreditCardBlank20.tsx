...
export const CreditCardBlank20 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    ...
    >
      <path
        d="M16.25 2.5C18.3211 2.5 20 4.17893 20 6.25V13.75C20 15.8211 18.3211 17.5 16.25 17.5H3.75C1.67893 17.5 1.20798e-08 15.8211 0 13.75V6.25C0 4.17893 1.67893 2.5 3.75 2.5H16.25ZM1.5 8.5V13.75C1.5 14.9926 2.50736 16 3.75 16H16.25C17.4926 16 18.5 14.9926 18.5 13.75V8.5H1.5ZM3.75 4C2.50736 4 1.5 5.00736 1.5 6.25V7H18.5V6.25C18.5 5.00736 17.4926 4 16.25 4H3.75Z"
        fill={color}
      />
    </svg>
  );
