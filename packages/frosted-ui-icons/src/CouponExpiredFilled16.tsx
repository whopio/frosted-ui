...
export const CouponExpiredFilled16 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    <svg
      ...
      data-fui-icon="CouponExpiredFilled16"
      {...props}
    >
      <path
        d="M5.294 0c.499 0 .886.285 1.102.629l.08.15.057.112c.3.542.853.89 1.467.89l.122-.006c.604-.045 1.135-.428 1.4-.996l.082-.15C9.819.285 10.206 0 10.705 0h1.045C12.993 0 14 1.007 14 2.25v11.5c0 1.243-1.007 2.25-2.25 2.25h-1.045c-.498 0-.885-.285-1.1-.629l-.194-.354c-.287-.455-.76-.752-1.289-.792L8 14.22c-.655 0-1.24.395-1.523 1-.19.407-.613.78-1.183.78H4.25C3.007 16 2 14.993 2 13.75V2.25C2 1.007 3.007 0 4.25 0h1.044zm5.236 5.47c-.293-.293-.767-.293-1.06 0L8.177 6.763c-.098.097-.256.097-.354 0L6.53 5.47c-.293-.293-.767-.293-1.06 0-.293.293-.293.767 0 1.06l1.293 1.293c.097.098.097.256 0 .354L5.47 9.47c-.293.293-.293.767 0 1.06.293.293.767.293 1.06 0l1.293-1.293c.098-.097.256-.097.354 0L9.47 10.53c.293.293.767.293 1.06 0 .293-.293.293-.767 0-1.06L9.237 8.177c-.097-.098-.097-.256 0-.354L10.53 6.53c.293-.293.293-.767 0-1.06z"
        fill={color}
      />
    </svg>
  );
