...
export const Profile24 = React.forwardRef<SVGSVGElement, IconProps>(
  ({ color = 'currentColor', ...props }, forwardedRef) => {
    return (
      ...
      >
        <path
          d="M15.7511 6.5C15.7511 8.57107 14.0722 10.25 12.0011 10.25 9.93004 10.25 8.25111 8.57107 8.25111 6.5 8.25111 4.42893 9.93004 2.75 12.0011 2.75 14.0722 2.75 15.7511 4.42893 15.7511 6.5zM12.0011 13.25C8.60997 13.25 6.03711 15.2643 4.9836 18.1129 4.5748 19.2182 5.51944 20.25 6.69796 20.25H17.3043C18.4828 20.25 19.4274 19.2182 19.0186 18.1129 17.9651 15.2643 15.3923 13.25 12.0011 13.25z"
          stroke={color}
          strokeWidth="1.5"
