...
export const BarChartVariable12 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    <svg
      width="12"
      height="12"
      ...
      data-fui-icon="BarChartVariable12"
      {...props}
    >
      <path
...
BarChartVariable12.category = 'Stats & Charts';

export default BarChartVariable12;
