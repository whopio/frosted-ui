  ...
  ({ color = 'currentColor', ...props }, forwardedRef) => {
    return (
      <svg
        ...
        ref={forwardedRef}
      >
        <g fill={color} clipPath="url(#clip0_526_288)">
          <path
            ...
            clipRule="evenodd"
          />
          <path d="M9 10.5C9 11.0523 8.55228 11.5 8 11.5C7.44772 11.5 7 11.0523 7 10.5C7 9.94772 7.44772 9.5 8 9.5C8.55228 9.5 9 9.94772 9 10.5Z" />
          <path
