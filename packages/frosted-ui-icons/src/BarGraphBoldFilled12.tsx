...
export const BarGraphBoldFilled12 = ({ color = 'currentColor', ...props }: IconProps) => {
  return (
    <svg
      width="12"
      height="12"
      ...
      data-fui-icon="BarGraphBoldFilled12"
      {...props}
    >
      <path
...
BarGraphBoldFilled12.category = 'Stats & Charts';

export default BarGraphBoldFilled12;
